...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	*/
	function getUserProfile()
	{
		...
		// EDIT: was https, bad for proxying
		$this->user->profile->photoURL      = "http://graph.facebook.com/" . $this->user->profile->identifier . "/picture?width=150&height=150";
		//$this->user->profile->photoURL      = (array_key_exists('picture',$data))?$data['picture']['data']:("https://graph.facebook.com/" . $this->user->profile->identifier . "/picture?width=150&height=150");
